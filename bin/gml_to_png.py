...
def gml_to_png(gml_file):
    # Parse GML/generate PNG

    #generate name
    name_tmp = os.path.split(gml_file)[1]
    name = name_tmp[:name_tmp.rfind('.')]

    return gml_to_image(name, gml_file, IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_TYPE , OUTLINE_RGB, FILL_RGB , "", "", "", 0)
...
if __name__ == '__main__':
    ...
    if not options or not options.gml:
        ...
        sys.stdout.write(gml_to_png(gml_file=options.gml))
